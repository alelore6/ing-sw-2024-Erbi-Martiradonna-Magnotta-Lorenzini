...
public class ClientApp {
    public static void main( String[] args ) throws RemoteException, NotBoundException {
        ...
        do{
            try{
                networkType = scanner.nextInt();
            } catch (NumberFormatException e) {
                System.out.println("It is not a valid number!!\n");
            }
            if(networkType != 0 && networkType != 1) {System.out.print("Enter 0 for RMI or 1 for Socket: \n");}

        }while(networkType != 0 || networkType != 1);

        System.out.println("TESTSUPERATO");

//        System.out.print("Choose if you want to play from CLI or GUI: 0 for CLI and 1 for GUI: \n");
//        while(typeView != 0 || typeView != 1){
//            try{
//                typeView = Integer.parseInt(scanner.next());
//            } catch (NumberFormatException e) {
//                System.out.println("It is not a valid number!!\n");
//            }
